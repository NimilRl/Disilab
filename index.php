...
<html lang="en">
    ...
    <!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 May 2021 04:56:25 GMT -->
...
<?php include_once './Php/header.php'; ?>
                    ...
                    <div class="col-lg-6 responsive-column-half">
                        <div class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                ...
                                <a href="home-2.html" class="btn theme-btn theme-btn-white">Browse questions <i class="la la-arrow-right icon ml-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- end col-lg-6 -->
                    <div class="col-lg-6 responsive-column-half">
                        <div class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                ...
                                <a href="free-demo.html" class="btn theme-btn theme-btn-white">Create a free team <i class="la la-arrow-right icon ml-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- end col-lg-6 -->
        ...
        <section class="client-logo-area section--padding bg-radial-gradient-gray">
            <div class="container">
                <div class="client-logo-box">
                    <h3 class="fs-21 text-center text-gray">Thousands of organizations around the globe use Disilab for Teams</h3>
        ...
        <section class="get-started-area section--padding pattern-bg" id="for-developers">
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="section-desc w-50 mx-auto">Disilab is an open community for anyone that codes. We help you get answers to your toughest coding questions, share knowledge with your coworkers in private, and find your next dream job.
                    </p>
                </div>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item hover-y text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text pb-4">This is just a simple text made for this unique and awesome template, you can easily edit it as you want.</p>
                                <a href="careers.html" class="btn theme-btn">Find a job <i class="la la-arrow-right icon ml-1"></i></a>
                            </div>
                            <!-- end card-body -->
                        </div>
                        <!-- end card -->
        ...
        <section class="get-started-area section--padding bg-gray" id="for-businesses">
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="section-desc w-50 mx-auto">This is just a simple text made for this unique and awesome template, you can replace it with any text.
                    </p>
                </div>
                <div class="row pt-50px">
                    <div class="col-lg-4 responsive-column-half">
        ...
        <section class="package-area section--padding bg-vertical-gradient-gray">
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="section-desc w-50 mx-auto pb-4">This is just a simple text made for this unique and awesome template, you can replace it with any text.
                    </p>
            ...
            <div class="container">
                <div class="testimonial-carousel owl-carousel owl-theme owl-action-styled">
                    <div class="carousel-card text-center">
                        <p class="section-desc w-75 mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem culpa deserunt dolor ea iure iusto magnam minima, recusandae sequi sunt? Corporis delectus deserunt dicta exercitationem ipsum, iusto magnam minus molestias numquam perspiciatis
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="Php/login.php">
                            ...
                            <div class="btn-box">
                                <button type="submit" name="login" class="btn theme-btn w-100">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="Php/signup.php">
                            ...
                            <div class="btn-box">
                                <button type="submit" name="btnsignup" class="btn theme-btn w-100">
    ...
    <!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 May 2021 04:56:37 GMT -->
